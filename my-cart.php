...
mysqli_query($con,"insert into ordenes(userId,productId,quantity) values('".$_SESSION['id']."','$qty','$val34')");
unset($_SESSION['cart']);
					...
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								...
								<input type="submit" name="submit" value="Actualizar carrito" class="btn btn-upper btn-primary pull-right outer-right-xs">
							</span>
		...
		<tbody>
				<tr>
					<td> 
						...
						<?php include 'paypalCheckout.php'; ?></button>
						</form>
