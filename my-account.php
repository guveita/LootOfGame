...
header('location:login.php');
	...
	if(isset($_POST['update']))
	{
		...
		$query=mysqli_query($con,"update usuarios set name='$name',contactno='$contactno' where id='".$_SESSION['id']."'");
		if($query)
		{
...
{
$sql=mysqli_query($con,"SELECT password FROM  usuarios where password='".md5($_POST['cpass'])."' && id='".$_SESSION['id']."'");
...
{
alert("El campo de la contraseña está vacío !!");
document.chngpwd.newpass.focus();
return false;
}
else if(document.chngpwd.cnfpass.value=="")
{
alert("El campo de confirmar la contraseña está vacío !!");
...
<?php
$query=mysqli_query($con,"select * from usuarios where id='".$_SESSION['id']."'");
...
<div class="form-group">
			 ...
			 <input type="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" value="<?php echo $row['email'];?>" readonly>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Contact No.">Telefono (10 Digitos) <span>*</span></label>
					    <input type="text" class="form-control unicase-form-control text-input" id="contactno" name="contactno" required="required" value="<?php echo $row['contactno'];?>"  maxlength="10" pattern="[0-9]{10}">
					  </div>
...
<div class="form-group">
			 ...
			 <input type="password" class="form-control unicase-form-control text-input" id="newpass" name="newpass">
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Confirm Password">Confirme la contraseña <span>*</span></label>
