		...
		<div class="row">
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">envío gratis en todos los productos</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">Todos los artículos hasta con un 20% de descuento </h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
...
?>
	...
	<div class="tab-pane" id="books">
		...
		<?php
$ret=mysqli_query($con,"select * from productos where category=3");
while ($row=mysqli_fetch_array($ret)) 
{
	# code...
	...
	<?php } ?>
		...
		<div class="tab-pane" id="furniture">
					<div class="product-slider">
						<div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
		<?php
$ret=mysqli_query($con,"select * from productos where category=5");
while ($row=mysqli_fetch_array($ret)) 
{
?>
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">Categoria 1</h3>
	                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	   
<?php
$ret=mysqli_query($con,"select * from productos where category=1");
while ($row=mysqli_fetch_array($ret)) 
{
?>
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">Categoria 2</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
$ret=mysqli_query($con,"select * from productos where category=2");
while ($row=mysqli_fetch_array($ret)) 
{
?>
