...
<h3>Lootofgame</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> Consigue los loots de tus juegos favoritos</p>
...
<div class="contact-timing">
	<div class="module-heading">
		<h4 class="module-title">Horario</h4>
	</div><!-- /.module-heading -->
		...
		<div class="table-responsive">
			<table class="table">
				<tbody>
					...
					<tr><td>Sabado:</td><td class="pull-right">09.00 a 20.00</td></tr>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">lootofgame@gmail.com.com</a></span>
                </div>
            </li>
