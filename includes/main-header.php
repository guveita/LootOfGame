...
<div class="logo">
	<a href="index.php">
		...
		<h1><img src="assets/images/logo.png" width="50" height="35">Lootofgame</h1>
	</a>
</div>		
</div>
...
<div class="search-area">
    <form name="search" method="post" action="search-result.php">
        <div class="control-group">
            ...
            <input class="search-field" placeholder="Buscar en la pagina..." name="product" required="required" />
	...
	?>
			...
			<div class="clearfix cart-total">
				<div class="pull-right">
						...
						<span class="text">Total :</span><span class='price'>MXN.<?php echo $_SESSION['tp']="$totalprice". ".00"; ?></span>
