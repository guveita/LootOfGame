...
<option value="">Seleciona el Categoria</option> 
...
<div class="controls">
<input type="text"    name="productName"  placeholder="Nombre del Producto" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text"    name="productCompany"  placeholder="Marca del producto" class="span8 tip" required>
</div>
</div>
<div class="control-group">
<label class="control-label" for="basicinput">Precio antes del descuento</label>
<div class="controls">
<input type="text"    name="productpricebd"  placeholder="Precio del producto" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text"    name="productprice"  placeholder="Precio con descuento" class="span8 tip" required>
</div>
</div>
