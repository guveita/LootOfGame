...
//unlink($dir.'/'.$pimage);
	...
	$sql=mysqli_query($con,"update  productos set productImage1='$productimage1' where id='$pid' ");
...
$query=mysqli_query($con,"select productName,productImage1 from productos where id='$pid'");
$cnt=1;
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen 1 Actual</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Nueva Imagen 1</label>
<div class="controls">
