...
$sql=mysqli_query($con,"insert into categoria(categoryName,categoryDescription) values('$category','$description')");
$_SESSION['msg']="Categoria Creada !!";
...
if(isset($_GET['del']))
		  {
                  ...
                  $_SESSION['delmsg']="Categoria Eliminada !!";
		  }
...
<div class="controls">
<input type="text" placeholder="Nombre de la Categoria"  name="category" class="span8 tip" required>
</div>
</div>
...
?>									
										<tr>
											...
											<a href="category.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('¿Estás seguro de que quieres eliminar?')"><i class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
