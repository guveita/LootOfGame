...
if(isset($_POST['submit']))
{
	...
	$sql=mysqli_query($con,"update  productos set productImage3='$productimage3' where id='$pid' ");
...
$query=mysqli_query($con,"select productName,productImage3 from productos where id='$pid'");
$cnt=1;
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen 3 Actual</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Nueva Imagen 3</label>
<div class="controls">
