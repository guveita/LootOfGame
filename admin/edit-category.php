...
if(isset($_POST['submit']))
{
	...
	$id=intval($_GET['id']);
$sql=mysqli_query($con,"update categoria set categoryName='$category',categoryDescription='$description',updationDate='$currentTime' where id='$id'");
$_SESSION['msg']="Categoria Actualizada !!";
...
<?php
$id=intval($_GET['id']);
$query=mysqli_query($con,"select * from categoria where id='$id'");
...
<div class="controls">
<input type="text" placeholder="Nombre de la categoria"  name="category" value="<?php echo  htmlentities($row['categoryName']);?>" class="span8 tip" required>
</div>
</div>
