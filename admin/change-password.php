...
$_SESSION['msg']="Contraseña cambiada !!";
}
else
{
$_SESSION['msg']="La contraseña actual es incorrecta, Vuelve a intentarlo!!";
}
}
?>
<!DOCTYPE html>
...
{
alert("El campo de nueva contraseña esta vacio !!");
...
<div class="controls">
<input type="password" placeholder="Repite la contraseña nueva"  name="confirmpassword" class="span8 tip" required>
</div>
</div>
