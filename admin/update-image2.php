...
//unlink($dir.'/'.$pimage);
	...
	$sql=mysqli_query($con,"update  productos set productImage2='$productimage2' where id='$pid' ");
...
$query=mysqli_query($con,"select productName,productImage2 from productos where id='$pid'");
$cnt=1;
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen 2 Actual</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Nueva Imagen 2</label>
<div class="controls">
