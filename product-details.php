	...
	if(isset($_SESSION['cart'][$id])){
		...
		if(mysqli_num_rows($query_p)!=0){
			...
			$_SESSION['cart'][$row_p['id']]=array("quantity" => 1, "price" => $row_p['productPrice']);
					echo "<script>alert('El producto fue añadido al carrito')</script>";
...
{
mysqli_query($con,"insert into listadeseo(userId,productId) values('".$_SESSION['id']."','$pid')");
echo "<script>alert('Producto incluido en la lista de deseos');</script>";
...
if(isset($_POST['submit']))
{
	...
	$review=$_POST['review'];
	mysqli_query($con,"insert into resenas(productId,quality,price,value,name,summary,review) values('$pid','$qty','$price','$value','$name','$summary','$review')");
}
...
<?php
$ret=mysqli_query($con,"select categoria.categoryName as catname,productos.productName as pname from productos join categoria on categoria.id=productos.category where productos.id='$pid'");
...
<?php 
$ret=mysqli_query($con,"select * from productos where id='$pid'");
...
<?php $rt=mysqli_query($con,"select * from resenas where productId='$pid'");
...
<div class="stock-container info-container m-t-10">
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price">MXN. <?php echo htmlentities($row['productPrice']);?></span>
...
<?php $qry=mysqli_query($con,"select * from resenas where productId='$pid'");
...
<textarea class="form-control txt txt-review" id="exampleInputReview" rows="4" placeholder="" name="review" required="required"></textarea>
														...
														<div class="action text-right">
															<button name="submit" class="btn btn-primary btn-upper">Subir Reseña</button>
														</div><!-- /.action -->
...
<section class="section featured-product wow fadeInUp">
	...
	<div class="owl-carousel home-owl-carousel upsell-product custom-carousel owl-theme outer-top-xs">
		...
		<?php 
$qry=mysqli_query($con,"select * from productos where category='$cid' ORDER BY RAND()
LIMIT 5;");
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					MXN.<?php echo htmlentities($rw['productPrice']);?>			</span>
										     <span class="price-before-discount">MXN.
