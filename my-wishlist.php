...
if(isset($_GET['del']))
{
$query=mysqli_query($con,"delete from listadeseo where id='$wid'");
}


if(isset($_GET['action']) && $_GET['action']=="add"){
	$id=intval($_GET['id']);
	$query=mysqli_query($con,"delete from listadeseo where productId='$id'");
...
<div class="body-content outer-top-bd">
	...
	<div class="table-responsive">
		<table class="table">
			...
			<tbody>
<?php
$ret=mysqli_query($con,"select productos.productName as pname,productos.productName as proid,productos.productImage1 as pimage,productos.productPrice as pprice,listadeseo.productId as pid,listadeseo.id as wid from listadeseo join productos on productos.id=listadeseo.productId where listadeseo.userId='".$_SESSION['id']."'");
...
<?php $rt=mysqli_query($con,"select * from resenas where productId='$pd'");
...
?>
				...
				<?php } } else{ ?>
				<tr>
					<td style="font-size: 18px; font-weight:bold ">Tu lista de deseos esta vacias</td>
