...
{
mysqli_query($con,"insert into listadeseo(userId,productId) values('".$_SESSION['id']."','".$_GET['pid']."')");
echo "<script>alert('EL producto se añadio a tu lista de deceos');</script>";
				...
				<div class="caption vertical-top text-left">
					<div class="big-text">
						<br />
					       ...
					       <?php $sql=mysqli_query($con,"select categoryName  from categoria where id='$cid'");
while($row=mysqli_fetch_array($sql))
{
    ?>
					...
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane active " id="grid-container">
							<div class="category-product  inner-top-vs">
								<div class="row">									
			<?php
$ret=mysqli_query($con,"select * from productos where category='$cid'");
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					MXM. <?php echo htmlentities($row['productPrice']);?>			</span>
										     <span class="price-before-discount">MXM. <?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>
	  ...
	  <?php } } else {?>
		...
		<div class="col-sm-6 col-md-4 wow fadeInUp"> <h3>Ningún producto encontrado</h3>
		</div>
